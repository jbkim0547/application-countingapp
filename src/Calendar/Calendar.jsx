            ...
            <div className="events">
                {showEventPopup && (<div className="event-popup">
                    <div className="time-input">
                        ...
                        <input type="number" name="minutes" min={0} max={60} className='hours' value={eventTime.minutes} onChange={(e) => setEventTime({ ...eventTime, minutes: e.target.value })} />
                    </div>
                    <textarea placeholder='Enter Event Text (Maximum 60)' value={eventText} onChange={(e) => {
